...
version: 1.0.0
description: |
  Guide for establishing a disciplined, atomic git commit workflow. Helps organize
  modified and untracked files into logical feature/component groups, stage them,
  and write descriptive conventional commits (e.g. feat, fix, chore, docs, test).
license: MIT
compatibility: any
allowed-tools:
  - run_command
